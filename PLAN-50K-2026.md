...
#### Composants : 76 | Hooks : 72+ | Tests : 436 unit + 192+ E2E | Migrations DB : 25
...
| Lacune | Impact sur 50K | Priorite |
|--------|---------------|----------|
| Seulement 2 tiers (free/premium a 4,99) | CRITIQUE - ARPU trop bas | S1 |
| Free tier trop genereux (2 squads, 30j, illimite) | CRITIQUE - pas de friction | S1 |
| Pas de systeme de parrainage | ELEVE - pas de croissance virale | S3 |
...
| Pas de social sharing in-app | MOYEN - viralite limitee | S7 |
...
| `is_user_premium()` binaire dans DB | BLOQUANT - empeche 4 tiers | S1 |
| `stripe-webhook` hardcode 'premium' | BLOQUANT - empeche 4 tiers | S1 |
...
### 1.1 Restructuration du pricing [Semaine 1-2] — MUST-HAVE
...
- [ ] Creer produit "Squad Leader" avec 2 prix (14,99/mois, 143,88/an)
- [ ] Creer produit "Club" avec 2 prix (39,99/mois, 383,88/an)
- [ ] Mettre a jour produit "Premium" (4,99 → 6,99/mois, 47,88 → 59,88/an)
...
### 1.2 Reduction des limites Free [Semaine 1] — MUST-HAVE
...
### 1.3 Page Premium redesignee [Semaine 2] — MUST-HAVE
...
### 1.4 Systeme de parrainage [Semaine 3] — MUST-HAVE
...
### 1.5 Partage social [Semaine 4] — NICE-TO-HAVE
