    ...
    <div className="min-h-screen bg-bg-base flex">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <a
            href="/squads"
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-text-secondary hover:bg-bg-hover transition-colors text-sm"
          >
            Mes Squads
          </a>
          <a
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <div className="lg:hidden mt-6 flex flex-wrap gap-2 justify-center">
            <a
              href="/squads"
              className="px-4 py-2 rounded-lg bg-bg-elevated text-text-secondary text-sm hover:bg-bg-hover transition-colors"
            >
              Squads
            </a>
            <a
