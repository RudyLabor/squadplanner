          ...
          >
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 px-4 bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.08)] rounded-xl text-[14px] text-text-primary placeholder:text-text-quaternary focus:outline-none focus:border-[rgba(99,102,241,0.4)] transition-colors"
                  maxLength={200}
                  autoFocus
                />
              </div>
              ...
              <div>
                  ...
                  {options.map((option, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="flex-1 h-10 px-3 bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.08)] rounded-lg text-[13px] text-text-primary placeholder:text-text-quaternary focus:outline-none focus:border-[rgba(99,102,241,0.4)] transition-colors"
                        maxLength={100}
                      />
                      {options.length > 2 && (
                        <button
                          ...
                          className="p-1.5 rounded-lg text-text-quaternary hover:text-red-400 hover:bg-[rgba(239,68,68,0.1)] transition-colors"
                        >
                ...
                {options.length < 6 && (
                  <button
                    ...
                    className="mt-2 flex items-center gap-1.5 text-[13px] text-[#818cf8] hover:text-[#a5b4fc] transition-colors"
                  >
            ...
            <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-[rgba(255,255,255,0.06)]">
              ...
              <button
                ...
                disabled={!isValid}
                className="px-5 py-2.5 rounded-xl text-[13px] font-semibold bg-[#6366f1] text-white hover:bg-[#7c7ffa] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Creer le sondage
              </button>
            </div>
