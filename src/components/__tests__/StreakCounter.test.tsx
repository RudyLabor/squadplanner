...
vi.mock('../streak/streakUtils', () => ({
  ...
  getNextMilestone: vi
    .fn()
    .mockReturnValue({ label: '1 semaine', emoji: '🔥', xp: 50, progress: 43, daysRemaining: 4 }),
  getFlameIntensity: vi.fn().mockReturnValue(1),
  getFlameColors: vi
    .fn()
    .mockReturnValue({ primary: '#FF6B35', secondary: '#FFC107', glow: 'rgba(255,107,53,0.3)' }),
}))
