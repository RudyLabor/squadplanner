        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 scrollbar-hide">
          {messages.map((msg) => (
            ...
            >
              ...
              <div
                className={`max-w-[80%] rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed ${msg.role === 'user' ? 'bg-primary-bg text-white rounded-br-md' : 'bg-bg-elevated border border-border-subtle text-text-primary rounded-bl-md'}`}
              >
                {msg.text}
              </div>
            </m.div>
