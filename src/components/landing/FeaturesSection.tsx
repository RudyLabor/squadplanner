...
const pillars = [
  ...
  },
  {
    ...
    description: 'Propose un créneau. Chacun répond OUI ou NON. Pas de « peut-être ». On sait qui vient.',
    ...
    detailText: 'Propose un créneau. Chaque pote répond OUI ou NON. Pas de « peut-être ». La session se confirme quand vous êtes assez. Plus de ghosting.',
  },
  {
    id: 'reliability',
    icon: Target,
