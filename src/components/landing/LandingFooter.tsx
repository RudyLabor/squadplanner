        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-0">
              ...
              <li>
                <a href="https://x.com/squadplannerfr" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 py-2 text-md text-text-tertiary hover:text-text-primary transition-colors min-h-[44px]">
