        ...
        {mockMembers.slice(0, 4).map((member, i) => (
          ...
          >
            <div className="relative">
              ...
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold text-text-primary ${i === 0 ? 'ring-1 ring-success/30' : ''}`}
            ...
            <div className="flex-1">
              <div
                className={`text-xs font-medium ${i === 0 ? 'text-success' : 'text-text-primary'}`}
              >
                {member.name}
              </div>
