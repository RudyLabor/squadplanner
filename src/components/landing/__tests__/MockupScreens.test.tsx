...
vi.mock('../MockupScreensParty', () => ({
  PartyScreen: () => createElement('div', null, 'PartyScreen'),
  ProfileScreen: () => createElement('div', null, 'ProfileScreen'),
}))

import { HomeScreen, SquadScreen, screens } from '../MockupScreens'
...
describe('MockupScreens', () => {
  ...
  it('SquadScreen renders without crash', () => {
    render(<SquadScreen />)
    expect(screen.getByText('Les Invaincus')).toBeInTheDocument()
  })

  it('exports screens config', () => {
