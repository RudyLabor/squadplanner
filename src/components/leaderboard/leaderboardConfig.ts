...
export const getLevelColor = (level: number): { color: string; bg15: string; bg20: string } => {
  if (level >= 50) return { color: 'var(--color-gold)', bg15: 'var(--color-gold-15)', bg20: 'var(--color-gold-20)' }
  if (level >= 30) return { color: 'var(--color-primary-hover)', bg15: 'var(--color-primary-hover-15)', bg20: 'var(--color-primary-hover-30)' }
  if (level >= 20) return { color: 'var(--color-success)', bg15: 'var(--color-success-15)', bg20: 'var(--color-success-20)' }
  if (level >= 10) return { color: 'var(--color-primary)', bg15: 'var(--color-primary-15)', bg20: 'var(--color-primary-20)' }
  return { color: 'var(--color-text-secondary)', bg15: 'var(--color-overlay-light)', bg20: 'var(--color-overlay-medium)' }
}
