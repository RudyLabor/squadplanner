...
function buildTipPool(streakDays: number, reliability: number): DynamicTip[] {
  ...
  tips.push(
    ...
    {
      text: 'Consulte tes stats pour voir ta progression et identifier tes points forts.',
      badge: 'CONSEIL',
    }
  )
...
function getCoachStyle(hasRealTip: boolean, aiCoachTone?: string, tipBadge?: string) {
  if (hasRealTip) {
    ...
    return {
      ...
      badgeBg: 'bg-purple-15 text-purple',
      badgeLabel: 'CONSEIL',
    }
  }
...
export function ProfileCoachCard({
  ...
  const style = useCallback(
    () => getCoachStyle(hasRealTip, aiCoachTip?.tone, currentTip?.badge),
          ...
          <div className="flex-1 min-w-0">
            ...
            {!hasRealTip && (
              <div className="flex items-center gap-2 mt-3">
                ...
                <button
                  onClick={() => {
                    const el = document.querySelector('[aria-label="Statistiques"]')
