...
vi.mock('../../ui', () => ({
  ...
  ProgressRing: ({ value }: any) =>
    createElement('div', { 'data-testid': 'progress-ring' }, `${value}%`),
  AnimatedCounter: ({ end, suffix }: any) =>
    createElement('span', { 'data-testid': 'counter' }, `${end}${suffix || ''}`),
...
describe('ProfileStats', () => {
  ...
  it('shows Confirme tier for score 50-69', () => {
    render(
      <ProfileStats
        profile={{ ...defaultProfile, reliability_score: 55, total_sessions: 5, total_checkins: 3 }}
        profileReady={true}
      />
    )
  ...
  it('shows Expert tier for score 70-84', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 75 }} profileReady={true} />
    )
  ...
  it('shows Master tier for score 85-94', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 90 }} profileReady={true} />
    )
  ...
  it('shows Legende tier for score >= 95', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 95 }} profileReady={true} />
    )
  ...
  it('shows Legende at exactly 100', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 100 }} profileReady={true} />
    )
    expect(screen.getByText('Légende')).toBeInTheDocument()
  })
  ...
  it('considers hasNoActivity only when BOTH sessions and checkins are 0', () => {
    ...
    render(
      <ProfileStats
        profile={{ reliability_score: 50, total_sessions: 1, total_checkins: 0, level: 1, xp: 0 }}
        profileReady={true}
      />
    )
    expect(screen.queryByText('Planifie ta première session !')).not.toBeInTheDocument()
  ...
  it('shows next tier info when not at max tier', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 60 }} profileReady={true} />
    )
  ...
  it('shows max rank message for Legende tier', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 98 }} profileReady={true} />
    )
  ...
  it('applies glow effect for Legende tier', () => {
    const { container } = render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 96 }} profileReady={true} />
    )
    const glowCard = container.querySelector('.ring-1')
    expect(glowCard).toBeInTheDocument()
  })
  ...
  it('defaults level to 1 when undefined', () => {
    render(
      <ProfileStats
        profile={{ total_sessions: 1, total_checkins: 1, reliability_score: 50 }}
        profileReady={true}
      />
    )
  ...
  it('defaults xp to 0 when undefined', () => {
    render(
      <ProfileStats
        profile={{ total_sessions: 1, total_checkins: 1, reliability_score: 50, level: 1 }}
        profileReady={true}
      />
    )
  ...
  it('shows Debutant at score 0 with activity', () => {
    render(
      <ProfileStats
        profile={{ ...defaultProfile, reliability_score: 0, total_sessions: 1, total_checkins: 1 }}
        profileReady={true}
      />
    )
    expect(screen.getByText('Débutant')).toBeInTheDocument()
  ...
  it('shows Confirme at exactly score 50', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 50 }} profileReady={true} />
    )
    expect(screen.getByText('Confirmé')).toBeInTheDocument()
  })
  ...
  it('shows Expert at exactly score 70', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 70 }} profileReady={true} />
    )
    expect(screen.getByText('Expert')).toBeInTheDocument()
  })
  ...
  it('shows Master at exactly score 85', () => {
    render(
      <ProfileStats profile={{ ...defaultProfile, reliability_score: 85 }} profileReady={true} />
    )
    expect(screen.getByText('Master')).toBeInTheDocument()
  })
  ...
  it('shows Debutant at score 49 (just below Confirme)', () => {
    render(
      <ProfileStats
        profile={{ ...defaultProfile, reliability_score: 49, total_sessions: 1, total_checkins: 1 }}
        profileReady={true}
      />
    )
    expect(screen.getByText('Débutant')).toBeInTheDocument()
