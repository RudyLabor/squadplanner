...
const glossaryTerms: GlossaryTerm[] = [
  ...
  { term: 'Check-in', definition: "Confirmation de présence réelle à une session de jeu. Prouve que tu es là, pas juste inscrit.", link: { label: 'Comment ça marche', to: '/how-it-works' } },
  ...
  { term: 'Ghost / Ghosting', definition: "Ne pas se présenter à une session sans prévenir. Le cauchemar de tout organisateur de squad.", link: { label: 'Score de fiabilité', to: '/features/score-fiabilite' } },
  ...
  { term: 'LFG', definition: "Looking For Group. Quand tu cherches des joueurs pour former une équipe.", link: { label: 'Trouver des joueurs', to: '/lfg/valorant' } },
  ...
  { term: 'XP', definition: "Points d'expérience gagnés en participant aux sessions, en complétant des challenges et en maintenant ton streak.", link: { label: 'Gamification', to: '/features/gamification' } },
]
