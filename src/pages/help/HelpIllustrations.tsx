...
function CreateSquadIllustration() {
  return (
    <svg
      ...
      role="img"
      aria-label="Étapes pour créer une squad : cliquer plus, nommer, partager le code"
    >
      <rect
        x="0"
        y="10"
      ...
      <path
        d="M447 68 L453 65 M453 65 L453 71 M453 65 L449 63"
        stroke="var(--color-success)"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
function ReliabilityScoreIllustration() {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Jauge de score de fiabilité : rouge 0-59, jaune 60-79, vert 80-100"
    >
      <path
        d={arcPath(0, 0.59)}
...
function PlanSessionIllustration() {
  return (
    <svg
      ...
      role="img"
      aria-label="Planifier une session : calendrier, heure et nombre de joueurs"
    >
      <rect
        x="10"
        y="10"
      ...
      {[0, 1, 2, 3, 4].map((i) => (
        <g key={i}>
          <circle
            ...
            cy={100}
            r="8"
            fill={i < 3 ? 'var(--color-success-20)' : 'var(--color-success-10)'}
            stroke="var(--color-success)"
            strokeWidth="1"
          ...
          <circle
            ...
            cy={97}
            r="3"
            fill={i < 3 ? 'var(--color-success)' : 'none'}
            stroke={i < 3 ? 'none' : 'var(--color-success)'}
            strokeWidth="0.8"
            strokeDasharray={i < 3 ? 'none' : '2 2'}
          />
        </g>
...
function JoinVoiceIllustration() {
  return (
    <svg
      ...
      role="img"
      aria-label="Rejoindre une party vocale : cliquer Rejoindre, autoriser le micro, connecté"
    >
      <rect
        x="0"
        y="8"
      ...
      <rect
        ...
        stroke="var(--color-warning)"
        strokeWidth="2"
        fill="var(--color-warning-20)"
      />
      <path
        d="M244 40 Q244 54 258 54 Q272 54 272 40"
        stroke="var(--color-warning)"
        strokeWidth="2"
        fill="none"
        strokeLinecap="round"
