...
vi.mock('../../../components/ui', () => ({
  ...
  Select: ({ options, value, onChange, ...props }: any) => createElement('select', { value, onChange: (e: any) => onChange(e.target.value), ...props }, options?.map((o: any) => createElement('option', { key: o.value, value: o.value }, o.label))),
}))
