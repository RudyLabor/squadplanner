    ...
    <div>
      ...
      <Card className="p-6 bg-bg-surface">
        <LegalSection title="1. Responsable du traitement" defaultOpen>
          <p>Le responsable du traitement des données personnelles est Squad Planner SAS, dont le siège social est situé en France.</p>
        ...
        <LegalSection title="7. Vos droits (RGPD)">
          ...
          <p className="mt-3">Pour exercer vos droits, contactez-nous à <span className="text-primary">privacy@squadplanner.fr</span> ou utilisez les options disponibles dans les Paramètres de l'application.</p>
        </LegalSection>
        ...
        <LegalSection title="11. Contact et réclamation">
          ...
          <p className="mt-2">Vous pouvez également introduire une réclamation auprès de la CNIL (Commission Nationale de l'Informatique et des Libertés) : <span className="text-primary">www.cnil.fr</span></p>
        </LegalSection>
      </Card>
    </div>
  )
