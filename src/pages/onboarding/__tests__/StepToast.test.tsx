...
describe('StepToast', () => {
  ...
  it('renders nothing visible when isVisible is false', () => {
    ...
    const { container } = render(
      <StepToast message="Hidden toast" isVisible={false} onClose={onClose} />
    )
  ...
  it('shows toast with message and Sparkles icon when isVisible is true', () => {
    ...
    const onClose = vi.fn()
    const { container } = render(
      <StepToast message="Squad créée !" isVisible={true} onClose={onClose} />
    )
  ...
  it('handles different messages and cleans up timer on unmount', () => {
    ...
    const { unmount, rerender } = render(
      <StepToast message="Profil mis à jour" isVisible={true} onClose={onClose} />
    )
    ...
    const { container } = render(
      <StepToast message="Session créée" isVisible={true} onClose={vi.fn()} />
    )
