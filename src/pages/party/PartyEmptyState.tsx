    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <Card className="p-8 text-center bg-gradient-to-br from-primary/[0.08] to-transparent border-primary">
        <div className="relative w-16 h-16 mx-auto mb-5">
          ...
          <motion.div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-purple flex items-center justify-center shadow-md shadow-primary/15" animate={{ scale: [1, 1.02, 1] }} transition={{ duration: 2, repeat: Infinity }}>
        ...
        <Link to="/squads">
          <Button className="shadow-md shadow-primary/10"><Users className="w-4 h-4" /> Trouver une squad</Button>
        </Link>
      </Card>
    </motion.div>
  )
