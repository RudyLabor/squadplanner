import { Users, Calendar, BarChart3, Sparkles, Mic2, Shield, Crown } from '../../components/icons'
export const FEATURES = [
  {
    name: 'Squads',
    free: '2 max',
    premium: 'Gère tous tes groupes sans limites',
    icon: Users,
    highlight: true,
  },
  {
    ...
    free: '30 jours',
    premium: "Retrouve n'importe quelle session",
    icon: Calendar,
    highlight: true,
  },
  {
    ...
    free: 'Basiques',
    premium: 'Prouve qui carry vraiment la squad',
    icon: BarChart3,
    highlight: true,
  },
  {
    ...
    premium: 'Découvre quand ta squad est la plus clutch',
    icon: Sparkles,
    highlight: true,
  },
  {
    ...
    free: 'Standard',
    premium: 'Élimine les lags audio en ranked',
    icon: Mic2,
    highlight: false,
  },
  {
