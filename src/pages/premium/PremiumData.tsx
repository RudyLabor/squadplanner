...
export const FEATURES = [
  { name: 'Squads', free: '2 max', premium: 'Gère tous tes groupes sans limites', icon: Users, highlight: true },
  { name: 'Historique sessions', free: '30 jours', premium: 'Retrouve n\'importe quelle session', icon: Calendar, highlight: true },
  { name: 'Stats & Analytics', free: 'Basiques', premium: 'Prouve qui carry vraiment la squad', icon: BarChart3, highlight: true },
  { name: 'IA Coach', free: 'Conseils simples', premium: 'Découvre quand ta squad est la plus clutch', icon: Sparkles, highlight: true },
  { name: 'Qualité audio Party', free: 'Standard', premium: 'Élimine les lags audio en ranked', icon: Mic2, highlight: false },
  { name: 'Rôles squad', free: 'Membre / Admin', premium: 'Shotcaller, IGL, Coach...', icon: Shield, highlight: false },
