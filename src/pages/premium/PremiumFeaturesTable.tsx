      ...
      <Card className="overflow-hidden">
        ...
        <div className="divide-y divide-border-default">
          {FEATURES.map((feature, index) => (
            <div
              key={feature.name}
              className={`animate-fade-in-up grid grid-cols-[1.5fr_1fr_1.2fr] md:grid-cols-3 gap-2 md:gap-4 p-4 items-center ${feature.highlight ? 'bg-primary-5' : ''}`}
            ...
            >
              ...
              <div className="text-center min-w-0">
                {typeof feature.premium === 'boolean' ? (
                  ...
                  <span className="text-base font-medium text-success break-words">
                    {feature.premium}
                  </span>
                )}
              </div>
