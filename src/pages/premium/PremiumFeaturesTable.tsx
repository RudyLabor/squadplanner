      ...
      <Card className="overflow-hidden">
        ...
        <div className="divide-y divide-border-default">
          {FEATURES.map((feature, index) => (
            <motion.div key={feature.name} initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-20px' }} transition={{ delay: index * 0.06, duration: 0.35, ease: 'easeOut' }}
