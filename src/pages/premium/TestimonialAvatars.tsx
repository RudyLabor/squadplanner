export function TestimonialAvatar({ type }: { type: 'alex' | 'marie' | 'lucas' }) {
  if (type === 'alex') {
    return (
      ...
      >
        ...
        />
        <path
          d="M21 28.5 C22.5 30 25.5 30 27 28.5"
          stroke="#C4917A"
          strokeWidth="1"
          strokeLinecap="round"
          fill="none"
  ...
  if (type === 'marie') {
    return (
      ...
      >
        ...
        <path
          d="M12 18 C12 10 17 6 24 6 C31 6 36 10 36 18 L37 36 C37 38 35 38 34 36 L34 22 L14 22 L14 36 C14 38 12 38 11 36Z"
          fill="url(#marieHair)"
        />
        ...
        <path
          d="M14 18 C14 11 18 7 24 7 C30 7 34 11 34 18 C34 15 31 11 24 11 C17 11 14 15 14 18Z"
          fill="url(#marieHair)"
        />
        ...
        <path
          d="M17.5 20.5 C18 19.8 19 19.5 20 19.8"
          stroke="#2D1B0E"
          strokeWidth="0.7"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M26 19.8 C27 19.5 28 19.8 28.5 20.5"
          stroke="#2D1B0E"
          strokeWidth="0.7"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M17.5 19 C18.5 18 21 18 22 18.5"
          stroke="#3A1A08"
          strokeWidth="0.9"
          strokeLinecap="round"
          fill="none"
        />
        <path
          d="M26 18.5 C27 18 29.5 18 30.5 19"
          stroke="#3A1A08"
          strokeWidth="0.9"
          strokeLinecap="round"
          fill="none"
        ...
        />
        <path
          d="M21 28 C22 29.5 26 29.5 27 28"
          stroke="#D09A7E"
          strokeWidth="1"
          strokeLinecap="round"
          fill="none"
  ...
  return (
    ...
    >
      ...
      <path
        d="M13 19 C13 11 17 7 24 7 C31 7 35 11 35 19 L35 17 C35 17 34 14 24 14 C14 14 13 17 13 17Z"
        fill="#1F2937"
      />
      <rect x="12" y="16" width="24" height="4" rx="2" fill="#374151" />
      <path d="M12 18 L36 18" stroke="#4B5563" strokeWidth="0.8" />
      <path
        d="M14 17 C16 16.5 20 16 24 16 C28 16 32 16.5 34 17"
        stroke="#4B5563"
        strokeWidth="0.6"
        fill="none"
      />
      <path
        d="M14 19 C14 19 15 20 16 19.5"
        stroke="#6B4226"
        strokeWidth="1.5"
        strokeLinecap="round"
        fill="none"
      ...
      />
      <path
        d="M20.5 29 C22 30.5 26 30.5 27.5 29"
        stroke="#B8876A"
        strokeWidth="1"
        strokeLinecap="round"
        fill="none"
      />
      {[18, 19.5, 21, 27, 28.5, 30].map((cx, i) => (
        <circle key={i} cx={cx} cy={29 + (i % 3) * 1} r="0.35" fill="#8B6040" opacity="0.4" />
      ))}
      {[22.5, 25.5, 24, 19, 29].map((cx, i) => (
        <circle
          key={`s${i}`}
          cx={cx}
          cy={31 + (i > 2 ? 0 : 0.5)}
