    ...
    <section className="mb-6" aria-label="Sessions en attente de réponse">
      <div className="p-4 rounded-xl bg-warning-5 border border-warning" role="alert">
        ...
        <p className="text-base text-text-secondary mb-3">
          👉 <span className="text-text-primary">Réponds maintenant</span> pour que ta squad puisse
          s'organiser. Plus tu réponds vite, plus ton score de fiabilité augmente !
        </p>
