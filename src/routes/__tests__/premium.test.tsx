...
vi.mock('../../pages/Premium', () => ({ Premium: () => createElement('div', { 'data-testid': 'premium' }, 'Premium') }))
...
describe('routes/premium', () => {
  ...
  describe('meta', () => {
    ...
    it('returns complete SEO metadata for the premium page', () => {
      ...
      expect(canonical).toEqual({ tagName: 'link', rel: 'canonical', href: 'https://squadplanner.fr/premium' })
